...
**当前覆盖率（live evaluate-company，post-G3 catalog 66 字段）**：
- **CN 600519/2024**: source-first 42/66 (69%) clean → **+LLM 47/66 (77%)** ✓ regression-locked
- **HK 00001/2025 (HKD)**: source-first 32/66 (52%) + 1 terminal → **+LLM 37/66 (61%)** ✓
- **HK 01113/2025 (HKD)**: source-first 33/66 (54%) → **+LLM 37/66 (61%)** ✓
- **HK 01810/2024 (CNY)**: source-first 35/66 (57%) → **+LLM 42/66 (69%)** ✓
- **HK 02498/2024 (CNY)**: source-first 35/66 (57%) → **+LLM 40/66 (66%)** ✓
- **HK 06862/2024 (CNY)**: source-first 35/66 (57%) → **+LLM 40/66 (66%)** ✓
- **HK 09987/2024 (USD)**: source-first 34/66 (56%) → **+LLM 37/66 (61%)** ✓ (HK-B.8 accounts_receiv promoted)
