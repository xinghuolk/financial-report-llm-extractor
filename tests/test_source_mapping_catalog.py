...
def test_minimal_source_mapping_revenue_and_profit_market_policies(
    ...
    # Phase H2 Task 3: revenue CN restored to yahoo_direct cross-check +
    # select_primary_require_pdf (sample-verified via 600519/2024 PDF in
    # provider_raw_semantics_cn.json). net_profit unchanged.
