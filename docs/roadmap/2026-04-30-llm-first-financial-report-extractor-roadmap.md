...
>
> **HK companies (regression-locked)**: 00001/2025 source-first 28/56 (50%) → **+LLM 33/56 (59%)**; 01113/2025 source-first 29/56 (52%) → **+LLM 33/56 (59%)**; 01810/2024 source-first 32/56 (57%) → **+LLM 39/56 (70%)**; 02498/2024 source-first 32/56 (57%) → **+LLM 37/56 (66%)**; 06862/2024 source-first 33/56 (59%) → **+LLM 38/56 (68%)**; 09987/2024 source-first 29/56 (52%) → **+LLM 32/56 (57%)**. HK Bucket-A "alias gap" hypothesis collapsed empirically to ~0 cells per `docs/phase_hk_coverage_discovery.md` reality-check — most missing-candidate fields are genuinely absent from Yahoo HK + AKShare HK adapters, not catalog gaps. HK-B fixture prerequisite is now satisfied; recon is in `docs/phase_hk_b_recon.md`. HK-B.1 locks `acct_payable` as 3 clean / 3 conflict; HK-B.2 locks `fix_assets` as 3 clean / 3 conflict; HK-B.3 locks `accounts_receiv` as 6 conflict / 0 clean; HK-B.4 locks `gross_profit` as 4 conflict + 2 terminal-unverified / 0 clean. Next implementation slice should move beyond HK-B locks: either decide whether any HK-B field deserves a sample-scoped provider policy, or broaden issuer validation.
>
